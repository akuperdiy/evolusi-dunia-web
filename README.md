...
- **Responsive Design** - Media queries untuk mobile-first approach

## 📝 Catatan

- Website ini murni HTML dan CSS, tidak memerlukan server atau framework
- Semua file CSS sudah terorganisir di `assets/styles/main.css`
- Landing page menggunakan gradient background dan glassmorphism effect
- Timeline menggunakan layout vertikal dengan garis timeline di tengah

## 📄 Lisensi

Proyek ini dibuat untuk keperluan akademik - Proyek Akhir Kelompok Pemrograman Web 2025

---

**© 2025 Proyek Pembuatan Website | Infografis Mengenai Sejarah Teknologi Web**
